...
class AVLTree
  ...
  def self.remove!(root, value, done)
    if root
      ...
      root.subtrees[dir], done =
        AVLTree.remove!(root.subtrees[dir], value, done)
  ...
  def self.insert_unbounded!(root, value, done)
    ...
    root.subtrees[dir], done =
      AVLTree.insert_unbounded!(root.subtrees[dir], value, done)
  ...
  def self.remove_unbounded!(root, value, done)
    if root
      ...
      root.subtrees[dir], done =
        AVLTree.remove_unbounded!(root.subtrees[dir], value, done)
